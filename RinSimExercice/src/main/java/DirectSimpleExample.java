 ...
 */
public final class DirectSimpleExample {
  ...
  static class Driver implements MovingRoadUser, TickListener {
    ...
    public void initRoadUser(RoadModel model) {
      ...
      roadModel = model;
      goal = roadModel.getRandomPosition(rnd);
    }
    ...
    public void tick(TimeLapse timeLapse) {
      ...
      roadModel.moveTo(this, goal, timeLapse);
      if(roadModel.getPosition(this).equals(goal))
    	  goal = roadModel.getRandomPosition(rnd);
    }
